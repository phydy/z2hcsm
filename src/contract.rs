...
mod tests {
    ...
    use cosmwasm_std::{attr, from_binary}; // our instantate method
    ...
    fn test_execute_create_poll_valid() {
        ...
        assert_eq!(
            _res.attributes,
            vec![attr("action", "execute"), attr("poll", "created")]
        )
    }
    ...
    fn test_execute_vote_valid() {
        ...
        assert_eq!(
            _res.attributes,
            vec![attr("action", "execute"), attr("vote", "successful")]
        )
    }
